...
class LocationHelper {
    ...
    static createLocationMaterials(latitude, longitude, toleranceDistance) {
        let isNorth = false;
        let isWest = false;
        let quadrantsList = new Array();
        let leftLatitudeQuadrant;
        let rightLatitudeQuadrant;
        let leftLongitudeQuadrant;
        let rightLongitudeQuadrant;
